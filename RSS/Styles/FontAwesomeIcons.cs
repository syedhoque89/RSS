namespace RSS.Styles
{
	public static class FontAwesomeIcons
	{
		// Visual representation can be found here: https://fontawesome.com/icons?d=gallery&m=free
		// Usage: <Label Text="{x:Static styles:FontAwesomeIcons.GlassMartini}"/>
		// (Don't forget to add the namespace and set FontFamily="{StaticResource FontAwesomeSolid}")
